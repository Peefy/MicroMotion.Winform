...
namespace MicroMotion.Services
{
    ...
    {
        static readonly string user = AtapiDevice.GetHddInfo(0).SerialNumber; // 第一个硬盘;
        static readonly string RegFreeList = AtapiDevice.GetHddInfo(0).Firmware;

        static string savePath = Application.StartupPath + "\\MicroMotionV\\";
        static string userConfigFileName = "\\\\user_ones.uni";
